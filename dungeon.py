...
def intersection():
    ...
    if (intersection.lower() == 'forward' or intersection.lower() == 'f'):
        ...
        if (door.lower() == 'yes' or door.lower() == 'y'):
            ...
            intersection()
    elif (intersection.lower() == 'left' or intersection.lower() == 'l'):
        ...
        intersection()
    elif (intersection.lower() == 'right' or intersection.lower() == 'r'):
...
def room_2():
    ...
    room_1 = input("Would you like to explore the room or leave? Explore or Leave ")
    if (room_1.lower() == 'explore' or room_1.lower() == 'e'):
        print("There are plenty off ancient scrolls stacked on the shelves. You pull several out to look at but they are in a language you don't speak.")
...
with the effegy of a king on the lid. As you enter the room a voice calls out. 'Who dares enters my chamber?' do you answer or run?  """)
    ...
    if (boss_room_entrence.lower() == 'run' or boss_room_entrence.lower == 'r'):
        print("\nYou flee the room, sprinting back the way you came and out of the temple.")
        main_door()
...
def boss_battle():
    ...
    while Boss.stats["Health"] > 0 or Character.stats["Health"] > 0:
        if (Boss.initiative > Character.initiative):
            ...
            current_player_health = Character.stats["Health"] - boss.boss_damage # The players current health after damage. 
